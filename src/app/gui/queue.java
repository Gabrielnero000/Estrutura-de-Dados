...
public class queue extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        start_info = new javax.swing.JLabel();
        ...
        end_info = new javax.swing.JLabel();
        ...
        start_info.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        start_info.setForeground(new java.awt.Color(163, 73, 164));
        start_info.setText("N");

        size_info.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        size_info.setForeground(new java.awt.Color(163, 73, 164));
        size_info.setText("0");

        start_text.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        start_text.setForeground(new java.awt.Color(163, 73, 164));
        start_text.setText("Inicio:");
        ...
        end_text.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        end_text.setForeground(new java.awt.Color(163, 73, 164));
        end_text.setText("Fim:");

        end_info.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        end_info.setForeground(new java.awt.Color(163, 73, 164));
        end_info.setText("N");
    ...
    public void remove() {
        String aux = nodes[start].getValue();
        String aux2;
        nodes[start].setValue("N");
        nodes[start].setBackground(color);
        size--;
        if (size == 0) {
            nodes[start].setBackground(color);
            start_info.setText("N");
        ...
        nodes[start].setBackground(Color.green);
        start_info.setText(nodes[start].getValue());
        end_info.setText(nodes[end].getValue());
    }

    public void insert(String value) {
        end = (end + 1) % nodes.length;
        nodes[end].setValue(value);
        size++;
        nodes[end].setBackground(Color.red);
        if (end != 0) {
            nodes[end - 1].setBackground(color);
            nodes[start].setBackground(Color.green);
        }
        size_info.setText("" + size);
        start_info.setText(nodes[start].getValue());
    ...
    private javax.swing.JLabel end_info;
    ...
    private javax.swing.JLabel start_info;
